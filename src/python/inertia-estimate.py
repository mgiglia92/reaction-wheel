...
Wn = 10
sos = signal.butter(N=2, Wn=Wn, output='sos', fs=100, analog=False)

dir = path.dirname(__file__)
fname = os.path.join(dir, './data/weight-tests/vertical1.csv')
file = open(fname,'r')
...
sep1 = signal.find_peaks(jfilt, 4000)
sep2 = signal.find_peaks(-1*jfilt, 4000)
